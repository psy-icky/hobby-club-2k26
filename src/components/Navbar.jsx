...
export const Navbar = ({ onOpenTaskModal, onOpenMeetingModal, onOpenProfileModal }) => {
                ...
                <div className="absolute right-0 mt-2 w-72 rounded-xl bg-slate-900/95 border border-slate-800 shadow-2xl p-3 z-50 backdrop-blur-xl">
                  ...
                  <div className="pt-2 border-t border-slate-800 space-y-1">
                    <button
                      ...
                      className="w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs font-semibold text-indigo-300 hover:bg-indigo-600/15 transition-colors text-left"
                    >
                    ...
                    <button
                      ...
                      className="w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs font-semibold text-rose-400 hover:bg-rose-500/10 transition-colors text-left"
                    >
